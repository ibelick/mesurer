...
export function InspectInfoCard({
  ...
  return (
    <div
      ...
      className="msr:pointer-events-auto msr:absolute msr:z-50 msr:w-60 msr:rounded-lg msr:border msr:border-black/10 msr:bg-white msr:px-2 msr:py-2 msr:text-[10px] msr:text-ink-900 msr:shadow-floating msr:select-text"
