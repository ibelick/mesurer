...
const IconBase = ({ size = 24, className, ...props }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 256 256" fill="currentColor" aria-hidden="true" className={cn("msr:block", className)} onDragStart={(event) => event.preventDefault()} {...props} />
)
...
export const MoreIcon = ({ size = 12, ...props }: IconProps) => (
  <IconBase size={size} {...props} viewBox="0 0 12 12">
