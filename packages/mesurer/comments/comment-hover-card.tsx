...
export function CommentHoverCard({
  ...
  return (
    <div
      ...
      className="mesurer-comment-hover-card msr:pointer-events-auto msr:absolute msr:w-64 msr:rounded-lg msr:bg-white msr:p-3 msr:text-[12px] msr:text-ink-900 msr:shadow-floating"
